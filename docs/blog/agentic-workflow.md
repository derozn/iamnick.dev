...
3. **Voice pass** (existing **avoid-ai-writing** skill, edit-in-place with Nick's voice profile): AI-ism removal — runs _after_ fact fixes so it does not polish sentences about to be rewritten.
